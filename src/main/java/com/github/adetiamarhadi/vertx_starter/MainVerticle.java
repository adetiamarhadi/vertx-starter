...
public class MainVerticle extends AbstractVerticle {
  ...
  private void pageUpdateHandler(RoutingContext context) {
    ...
    this.jdbcClient.getConnection(car -> {
      if (car.succeeded()) {
        ...
        sqlConnection.updateWithParams(sql, params, res -> {
  ...
  private void pageRenderingHandler(RoutingContext context) {
    ...
    this.jdbcClient.getConnection(car -> {
      if (car.succeeded()) {
        ...
        SQLConnection sqlConnection = car.result();
        sqlConnection.queryWithParams(SQL_GET_PAGE, new JsonArray().add(page), fetch -> {
          ...
          if (fetch.succeeded()) {
            ...
            this.templateEngine.render(context.data(), "templates/page.ftl", ar -> {
              if (ar.succeeded()) {
  ...
  private void indexHandler(RoutingContext context) {
    this.jdbcClient.getConnection(car -> {
      if (car.succeeded()) {
        SQLConnection sqlConnection = car.result();
        sqlConnection.query(SQL_ALL_PAGES, res -> {
          sqlConnection.close();
          ...
          if (res.succeeded()) {
            ...
            this.templateEngine.render(context.data(), "templates/index.ftl", ar -> {
              if (ar.succeeded()) {
                context.response().putHeader("Content-Type", "text/html");
                context.response().end(ar.result());
              } else {
